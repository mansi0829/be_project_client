...
export default function Contact() {
  return (
    <div className="py-2 px-4 mx-auto w-1/2">
      <h2
        className="m-8 text-4xl font-extrabold 
      ...
      >
        Got a issue? Want to send feedback? Need details about our Company? Let
        us know.
      </p>
      <form action="#">
